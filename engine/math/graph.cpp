...
void CGraph::AddNode() { CGraph::nodes.push_back(CNode()); }
...
int CGraph::GetNumNodes() { return nodes.size(); }

CGraph::CNode *CGraph::GetNode(node_t i) { return &nodes[i]; }

int CGraph::GetNumEdges() { return edges.size(); }

CGraph::CEdge *CGraph::GetEdge(edge_t i) { return &edges[i]; }
