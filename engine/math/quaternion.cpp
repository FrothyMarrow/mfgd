...
// The basic equation is qpq* (the * means inverse) but we use a simplified
...
const Quaternion Quaternion::Slerp(const Quaternion &other, float t) const {
  ...
  // This is the quaternion equation that I discuss in the video, and it works
  // just fine! return ((r * q.Inverted()) ^ t) * q;
